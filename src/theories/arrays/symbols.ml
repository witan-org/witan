...
type Witan_core.Symbols.t +=
  | Select of {indices:Witan_core.Sorts.t; values:Witan_core.Sorts.t}
  | Store  of {indices:Witan_core.Sorts.t; values:Witan_core.Sorts.t}
  | Diff   of {indices:Witan_core.Sorts.t; values:Witan_core.Sorts.t}
