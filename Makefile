...
WHY3_FILES = $(addprefix src/core/, cmdline.ml cmdline.mli debug.ml	\
...
OCAML_FILES = $(addprefix src/core/, map_intf.ml exthtbl.ml	\
	exthtbl.mli extmap.ml extmap.mli extset.ml extset.mli )

FRAMAC_FILES = $(addprefix src/core/, intmap.ml intmap_hetero.ml	\
	intmap.mli intmap_hetero.mli bag.ml bag.mli)

JC_FILES = $(addprefix src/core/, leftistheap.ml leftistheap.mli)
